...
export const Table: FC<IProps> = observer(
  ({ sportsmen, onAddSportsman, onEditSportsmen, onDeleteSportsmen }: IProps) => {
    ...
    const columns: GridColumns = [
      ...
      { field: 'country', editable: true, headerName: 'Country', flex: 1 },
      { field: 'age', editable: true, type: 'number', headerName: 'Age' },
    ...
    return (
      <div className={styles.table}>
        <Button color="primary" startIcon={<AddIcon />} onClick={onAddSportsman}>
          Add sportsman
        </Button>
